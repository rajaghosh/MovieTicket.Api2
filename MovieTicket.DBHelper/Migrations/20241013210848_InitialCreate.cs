...
namespace MovieTicket.DBHelper.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "UserMaster",
                columns: new[] { "Id", "Email", "Location", "Name", "Password", "Role" },
                values: new object[,]
                {
                    { 1, "a1@deloitte.com", "Kolkata", "a1", "abc1@123", "Admin" },
                    { 2, "a2@deloitte.com", "Hyderabad", "a2", "abc2@123", "Admin" },
                    { 3, "a3@deloitte.com", "Pune", "a3", "abc3@123", "User" },
                    { 4, "a4@deloitte.com", "NCR", "a4", "abc4@123", "User" },
                    { 5, "a5@deloitte.com", "Hyderabad", "a5", "abc5@123", "User" }
                });
