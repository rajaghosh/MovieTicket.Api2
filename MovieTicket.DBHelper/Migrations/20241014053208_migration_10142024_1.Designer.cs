...
namespace MovieTicket.DBHelper.Migrations
{
    ...
    [Migration("20241014053208_migration_10142024_1")]
    partial class migration_10142024_1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MovieTicket.DBHelper.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ScreenId = 1,
                            SeatNo = "A",
                            ShowTime = new DateTime(2023, 10, 22, 14, 30, 0, 0, DateTimeKind.Local),
                            UserId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MovieTicket.DBHelper.Entities.MovieListing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieId = 1,
                            ScreenId = 1,
                            StartDate = new DateTime(2023, 10, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
